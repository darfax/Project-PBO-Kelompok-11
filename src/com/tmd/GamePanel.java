...
public class GamePanel extends JPanel implements Runnable {
	...
	public void checkCollision() {
		...
		if (ball.x <= 0) {
			...
			SwingUtilities.invokeLater(() -> {
				TMD.jLabel3.setText(String.valueOf(Score.player2 / 10) + String.valueOf(Score.player2 % 10));
			});
		...
		if (ball.x >= GAME_WIDTH - BALL_DIAMETER) {
			...
			newBall();
			SwingUtilities.invokeLater(() -> {
				TMD.jLabel5.setText(String.valueOf(Score.player1 / 10) + String.valueOf(Score.player1 % 10));
			});
	...
	public static void endGame() {
		...
		SwingUtilities.invokeLater(() -> {
			TMD.jLabel5.setText("00");
			TMD.jLabel3.setText("00");
		});
		closed();
