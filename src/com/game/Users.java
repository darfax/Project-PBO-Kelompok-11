...
class LeaderboardPanel extends JPanel {
    ...
    public LeaderboardPanel() {
        users = new ArrayList<>();
        // Tambahkan contoh pengguna ke leaderboard (biasanya dari database atau sumber
        // data lainnya)
        // users.add(new User(Crud.AllName[0], Crud.AllWin[0], Crud.AllPath[0]));
        // users.add(new User("User2", 8, "D:\\PRAKTIKUM PBO\\Project-PBO-Kelompok-11\\src\\upload\\Ansel.png"));
        // users.add(new User("User3", 3, "D:\\PRAKTIKUM PBO\\Project-PBO-Kelompok-11\\src\\upload\\adin.png"));
...
class UserListRenderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected,
        ...
        if (value instanceof User) {
            ...
            panel.setBackground(Color.WHITE); // Mengatur warna latar belakang panel menjadi putih
            ...
            numberAndPhotoPanel.add(Box.createRigidArea(new Dimension(5, 0))); // Jarak antara angka urutan dan foto

            JLabel photoLabel = new JLabel(user.getScaledPhoto(ICON_WIDTH, ICON_HEIGHT));
            numberAndPhotoPanel.add(Box.createHorizontalGlue()); // Untuk menggeser foto ke kanan
            ...
            usernameLabel.setPreferredSize(new Dimension(200, 60)); // Lebar 30 dan tinggi 25
            JPanel usernamePanel = new JPanel();
            usernamePanel.setPreferredSize(new Dimension(20, 50)); // Lebar 30 dan tinggi 25
            ...
            winsLabel.setPreferredSize(new Dimension(200, 30)); // Lebar 30 dan tinggi 25
            JPanel winsPanel = new JPanel();
            winsPanel.setPreferredSize(new Dimension(20, 50)); // Lebar 30 dan tinggi 25
